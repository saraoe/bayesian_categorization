...
ggsave("figs/gcm/chains_iteration_c_sub_1.png", p1,
    width = 7, height = 7
)
...
ggsave("figs/gcm/chains_iteration_w1_sub_1.png", p2,
    width = 7, height = 7
)
...
ggsave("figs/gcm/chains_iteration_w2_sub_1.png", p3,
    width = 7, height = 7
)
...
ggsave("figs/gcm/chains_iteration_w3_sub_1.png", p4,
    width = 7, height = 7
)
...
ggsave("figs/gcm/chains_iteration_w4_sub_1.png", p5,
    width = 7, height = 7
)
...
ggsave("figs/gcm/chains_iteration_w5_sub_1.png", p6,
    width = 7, height = 7
)
...
ggsave("figs/gcm/chains_iteration_sub_1.png",
    width = 7, height = 7
)
```
...
ggsave("figs/gcm/prior-pos-update-c_subject_1.png",
    width = 7, height = 5
)
```
...
weights_draws_df %>%
    group_by(condition, session, feature_number) %>%
    summarize(
        mean = mean(weights),
        median = median(weights),
        sd = sd(weights)
...
ggsave("figs/gcm/prior-pos-update-w_subject_1.png",
    width = 7, height = 5
)
```
