...
p <- ggplot(data = recovery_df) +
  ...
  facet_wrap(. ~ true_alpha_neg_round) +
  labs(
    title = "Posterior update: Alpha_negative",
...
p <- ggplot(data = recovery_df) +
  ...
  facet_wrap(. ~ true_alpha_pos_round) +
  labs(
    title = "Posterior update: Alpha_positive",
    fill = "Number of observations"
  ) +
  xlab("Alpha_positive")
...
p <- ggplot(data = recovery_df) +
  ...
  facet_wrap(. ~ true_temp_round) +
  labs(
    title = "Posterior update: Temperature",
    fill = "Number of observations"
  ) +
  xlab("Temperature")
...
p
ggsave("figs/parameter_recovery/rlsimple_pos-prior-update-alpha.png", p)
```
...
p
ggsave("figs/parameter_recovery/rlsimple_pos-alpha.png", p,
  width = 15, height = 10
)
```
...
p
ggsave("figs/parameter_recovery/rlsimple_pos-alphas_by_temp.png", p,
  width = 15, height = 10
)
```
...
p <- ggplot(data = recovery_df) +
  ...
  facet_wrap(. ~ true_alpha_round) +
  labs(
    title = "Posterior update: Alpha",
    fill = "Number of observations"
  ) +
  xlab("Alpha")

p
ggsave("figs/parameter_recovery/rlsimple_pos-alpha-neg_by_nobs.png", p)
```
...
p
ggsave("figs/parameter_recovery/rlsimple_pos-alpha-neg_by_temp.png", p)
```
...
p
ggsave("figs/parameter_recovery/rlsimple_pos-prior-update-temp.png", p)
```
...
p
ggsave("figs/parameter_recovery/rlsimple_pos-temp_by_nobs.png", p)
```
...
p
ggsave("figs/parameter_recovery/rlsimple_pos-temp.png", p)
```
...
p <- ggplot(data = recovery_df) +
  ...
  xlab("True Temperature") +
  ylab("Temperature") +
  labs(title = "Posterior Distributions of Temperature by Alpha")

p
ggsave("figs/parameter_recovery/rlsimple_pos-temp_by_alpha.png", p,
  width = 10, height = 10
)
```