...
Rscript src/parallel_pr.R gcm_fixed_c 1 104 binary &> logs/param_recov_gcm_fixed_c_1_104_binary.log &
Rscript src/parallel_pr.R gcm_fixed_c 1 208 binary &> logs/param_recov_gcm_fixed_c_1_208_binary.log &
Rscript src/parallel_pr.R gcm_fixed_c 1 312 binary &> logs/param_recov_gcm_fixed_c_1_312_binary.log &
