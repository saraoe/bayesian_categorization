...
neg <- ggplot(data = recovery_df) +
    geom_violin(
      aes(x = as.factor(true_alpha_neg), y = alpha_neg),
      fill = "red", alpha = 0.3
      ) +
    geom_boxplot(
      aes(x = as.factor(true_alpha_neg), y = alpha_neg),
    ...
    geom_line(
      aes(x = as.factor(true_alpha_neg), y = true_alpha_neg, group = 1),
      linetype = "dashed"
      ) +
    theme_bw() +
...
pos <- ggplot(data = recovery_df) +
    geom_violin(
      aes(x = as.factor(true_alpha_pos), y = alpha_pos),
      fill = "red", alpha = 0.3
      ) +
    geom_boxplot(
      aes(x = as.factor(true_alpha_pos), y = alpha_pos),
    ...
    geom_line(
      aes(x = as.factor(true_alpha_pos), y = true_alpha_pos, group = 1),
      linetype = "dashed"
      ) +
    theme_bw() +
...
neg + pos + 
    plot_annotation(title = "Posterior Distributions of alpha by temperature")
```
...
ggplot(data = recovery_df) +
    geom_violin(
      aes(x = as.factor(true_temp), y = temp),
      fill = "red", alpha = 0.3
      ) +
    geom_boxplot(
      aes(x = as.factor(true_temp), y = temp),
    ...
    geom_line(
      aes(x = as.factor(true_temp), y = true_temp, group = 1),
      linetype = "dashed"
      ) +
    theme_bw() + facet_wrap(. ~ true_alpha_neg) +
